...
class TmoNovelas implements PluginService {
  @override
  String get name => 'TMO Novelas';

  @override
  String get lang => 'es';

  @override
  String get siteUrl => 'https://tmonovelas.com';
  ...
  Future<List<Novel>> popularNovels(
    ...
    final url = '$siteUrl/novelas/page/$page/';
    try {
      ...
      for (final item in items) {
        ...
        if (title.isNotEmpty && path.isNotEmpty) {
          list.add(Novel(
            ...
            chapters: [],
            pluginId: name,
            genres: ['Novelas en Español', 'TMO Novelas'],
          ));
        }
      }
      return list;
  ...
  Future<Novel> parseNovel(String novelPath) async {
    ...
    final title = document.querySelector('.post-title h1')?.text.trim() ?? 'TMO Novelas';
