...
class EmpireNovels implements PluginService {
  @override
  String get name => 'Empire Novels';

  @override
  String get lang => 'pt';

  @override
  String get siteUrl => 'https://empirenovels.com.br';
  ...
  Future<List<Novel>> popularNovels(
    ...
    final url = '$siteUrl/novels/page/$page/';
    try {
      ...
      for (final item in items) {
        ...
        if (title.isNotEmpty && path.isNotEmpty) {
          list.add(Novel(
            ...
            author: 'Empire Novels',
            description: '',
            chapters: [],
            pluginId: name,
            genres: ['Novels em Português', 'Empire Novels'],
          ));
        }
      }
      return list;
  ...
  Future<Novel> parseNovel(String novelPath) async {
    ...
    final title = document.querySelector('.post-title h1')?.text.trim() ?? 'Empire Novels';
